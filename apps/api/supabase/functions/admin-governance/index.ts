      ...
      const prompts = [
        {
          ...
          related_files: ['apps/web/src/hooks/useAuth.tsx', 'apps/web/src/hooks/usePlatformAdmin.ts'],
        ...
        },
        {
          ...
          related_files: ['apps/api/supabase/functions/'],
        ...
        },
        {
          ...
          related_files: ['apps/api/supabase/functions/whatsapp-webhook/index.ts', 'apps/api/supabase/functions/widget-submit/index.ts'],
        },
        {
          ...
          related_files: ['.env', 'apps/api/supabase/functions/'],
        },
        {
