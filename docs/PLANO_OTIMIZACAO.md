...
- [~] **3F — `agent-orchestrator` (caminho mais quente).** ⚠️ **EM INVESTIGAÇÃO (2026-06-17): IA com erro** — validação anterior foi falso-positivo. Apurando se é do corte de colunas de `messages`/cache ou de outra mudança do dia.
