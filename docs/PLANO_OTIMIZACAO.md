...
- [x] **3F — `agent-orchestrator` (caminho mais quente).** ✅ **Validado em 2026-06-17** — IA respondendo normal num atendimento real (histórico com colunas restritas + cache de tags/pipelines/agents por org não afetaram o comportamento).
