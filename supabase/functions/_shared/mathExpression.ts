// Avaliador da expressão do nó "Cálculo" — cópia usada pelo motor de fluxos.
//
// GÊMEO: src/lib/mathExpression.ts, que a tela usa para a prévia ao vivo. Se um
// dos dois mudar, o outro muda junto — senão a prévia mente sobre o que vai
// acontecer com o lead. (Mesmo arranjo de _shared/agentPersonality.ts.)
//
// Nada de eval(): a expressão é escrita pelo dono do fluxo, mas os VALORES vêm
// do que o contato digitou. "1; fetch(...)" não pode virar código.
