// =====================================================================
// Extração de material de origem — artigo/blog (HTML) e transcrição de
// vídeo do YouTube (legenda/CC pública). Compartilhado entre
// carousel-extract-source (fonte avulsa de um carrossel) e a base de
// conhecimento do Projeto (item do tipo "link").
// =====================================================================
...
// ---------------------------------------------------------------------
export async function extractWebArticle(raw: string): Promise<{ title: string; content: string }> {
...
export async function extractYoutubeTranscript(raw: string): Promise<{ title: string; content: string }> {
...
/** Roteia por tipo — usado tanto pela extração avulsa quanto pelo item "link" da base de conhecimento. */
export async function extractSourceContent(
  type: "link" | "youtube",
  value: string,
): Promise<{ title: string; content: string }> {
  if (type === "youtube") return extractYoutubeTranscript(value);
  return extractWebArticle(value);
}
