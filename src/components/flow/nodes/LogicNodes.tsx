    ...
    >
      ...
      <div className="p-3 bg-card">
        <p className="text-xs text-muted-foreground">
          Se <span className="font-mono bg-muted px-1 rounded">{data.variable || 'variável'}</span>
        </p>
        <p className="text-xs text-muted-foreground mt-1">
          {data.operator || '='} <span className="font-mono bg-muted px-1 rounded">{data.value || 'valor'}</span>
        </p>
      </div>
