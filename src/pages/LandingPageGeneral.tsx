            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {segments.map(([name, desc], index) => (
                <Reveal key={name} delay={index * 45}>
                  <div className="flex h-full items-start gap-4 rounded-2xl border border-white/10 bg-white/[0.035] p-6 transition hover:-translate-y-1 hover:border-primary/30">
                    <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary/15 text-violet-200">
