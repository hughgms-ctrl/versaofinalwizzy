...
const dashboardAgents: Array<[string, string, string, React.ElementType]> = [
  ["Agente de Atendimento", "Respondendo e qualificando leads no WhatsApp agora", "ATIVO", MessageSquare],
  ["Agente de Agendamento", "3 reuniões fechadas nas últimas 2h", "ATIVO", Calendar],
  ["Agente de Pós-venda", "Coletando dados e enviando propostas", "ATIVO", FileSignature],
];

const pains = [
  "Leads chegando às 3h da manhã que ninguém respondeu",
  'WhatsApp da empresa lotado de gente perguntando "qual o valor?" e "vocês ainda atendem?"',
  "Horas perdidas marcando reuniões, cobrando documentos e repetindo a mesma resposta",
  "Ferramentas técnicas que precisam de programador para funcionar",
];

const solves = [
  "Agentes de IA prontos, treinados para o seu tipo de negócio",
  "Ativo em menos de 5 minutos",
  "Do primeiro contato até o contrato assinado, automatizado",
  "Sem webhooks, sem Make, sem ChatGPT separado",
  "Funciona 24/7, você foca no que sabe fazer",
];

const segments = [
  ["Clínicas e saúde", "Agenda cheia sem secretária respondendo WhatsApp o dia todo"],
  ["Agências e serviços", "Leads qualificados e reuniões marcadas automaticamente"],
  ["Comércio e e-commerce", "Atendimento, dúvidas e recuperação de carrinho no WhatsApp"],
  ["Imobiliárias", "Triagem de interessados e agendamento de visitas 24/7"],
  ["Educação e cursos", "Captação, qualificação e matrícula sem esforço manual"],
  ["Profissionais liberais", "Do primeiro contato à assinatura do contrato, sozinho"],
];
...
const products: Product[] = [
  {
    ...
    featured: true,
    description:
      "O centro de comando do seu negócio. Agentes de IA que captam, qualificam e fecham clientes 24/7 - enquanto você dorme, atende ou está em reunião.",
    features: [
      "Agentes de IA prontos para ativar, adaptados ao seu negócio",
      "Pipeline com movimentação automática e notificações",
      "Campanhas e agendamento de mensagens",
      "Follow-ups automáticos e personalizados por segmento",
      "Fluxos de atendimento do primeiro contato ao fechamento",
    ],
  },
  {
    icon: FileSignature,
    ...
    name: "Wizzy Sign",
    description:
      "Assinatura digital integrada. Chega de ZapSign, HelloSign ou qualquer outra ferramenta separada. Assine contratos e propostas direto no Wizzy.",
    features: [
      "Assinatura digital com validade jurídica",
      "Envio automático após a qualificação do lead",
  ...
  },
  {
    ...
    name: "Wizzy Flow",
    description:
      "Gestão de projetos e operação. Crie projetos, organize prazos, delegue tarefas e acompanhe tudo em calendário, timeline e kanban.",
    features: [
      "Projetos com prazos, responsáveis e tarefas atribuídas",
      "Colaboração entre time, parceiros e freelancers",
  ...
  },
  {
    ...
    name: "Wizzy Quest",
    description:
      "Qualifique leads antes mesmo de falar com eles. Quizzes inteligentes que filtram quem realmente tem perfil - e já segmentam por interesse.",
    features: [
      "Quizzes personalizados por produto ou serviço",
  ...
  },
  {
    ...
    name: "Wizzy Forms",
    description:
      "Formulários inteligentes para coleta de dados e documentos dos clientes. Chega de planilha do Excel para organizar informações.",
    features: [
      "Formulários customizáveis por tipo de atendimento",
...
const soonProducts = [
  ...
  ["Wizzy Engage", "Comentários e DMs do Instagram respondidos automaticamente"],
  ["E muito mais", "Sempre novos módulos para facilitar a vida de quem empreende"],
];

const agents = [
  [
    "Triagem & Qualificação",
    "Atende o lead no WhatsApp, entende o que a pessoa quer e filtra automaticamente quem tem perfil para comprar o seu produto ou serviço.",
    "Você só fala com quem está pronto para fechar. Fim do desperdício de tempo com curioso.",
  ],
  [
    "Agendamento de Reuniões",
    'Conversa com o lead qualificado, apresenta seus horários disponíveis e fecha a reunião direto na sua agenda - sem "vai e vem" de mensagens.',
    "Agenda cheia sem você abrir o WhatsApp uma única vez para marcar horário.",
  ],
  [
    "Coleta de Dados e Documentos",
    "Solicita, cobra e organiza tudo o que você precisa para dar andamento no atendimento (dados cadastrais, documentos, informações do pedido).",
    "Atendimento pronto para avançar sem ninguém do time cobrar o cliente dez vezes. Zero esforço humano.",
  ],
  [
    "Envio & Assinatura de Contrato",
    "Ao final da qualificação, envia automaticamente a proposta ou o contrato via Wizzy Sign e acompanha até a assinatura ser concluída.",
    "Do lead ao cliente assinado - tudo automatizado. Você só aparece para entregar o serviço.",
  ],
];
...
const testimonials = [
  [
    ...
    "O Wizzy mudou completamente o patamar da minha operação. O agente atende os leads de tráfego pago no WhatsApp de madrugada, qualifica quem realmente tem interesse e eu já começo o dia com a agenda cheia. Não precisei mexer em uma única linha de código, não precisei aprender nada técnico.",
  ],
  [
    "Ana Machado",
    "Agência de marketing - Belo Horizonte, MG",
    "Em 3 meses com o Wizzy, minha captação de clientes triplicou. O agente conversa com o lead, entende a necessidade e me manda o resumo pronto. Eu só entro para fechar a proposta.",
  ],
  [
    "Rodrigo Ferreira",
    "Imobiliária - Curitiba, PR",
    "Sempre achei que IA era coisa de startup de tecnologia, não para uma empresa como a minha. O Wizzy me provou o contrário. Tudo que eu precisava já estava pronto, só ativei. Em poucos dias meu WhatsApp ficou organizado.",
  ],
];
...
const faqs = [
  ...
  [
    ...
    "Sim. O Wizzy funciona para qualquer negócio que atenda clientes por WhatsApp ou Instagram: clínicas, agências, e-commerces, imobiliárias, escolas, prestadores de serviço, profissionais liberais e times comerciais. Você personaliza o tom, as perguntas e os fluxos do agente de acordo com o que a sua empresa vende.",
  ],
  [
    "Em quanto tempo começo a ver resultados?",
    "A maioria das empresas começa a ver resultados no primeiro dia - literalmente. Assim que você ativa o agente de atendimento e conecta o WhatsApp, ele começa a responder leads automaticamente. Em uma semana você já tem dados concretos de quantos leads foram qualificados, quantas reuniões foram agendadas e quanto tempo o time economizou.",
  ],
  [
    "O que acontece com os dados dos meus clientes?",
    "Seus dados são seus. O Wizzy opera em total conformidade com a LGPD. Os dados dos seus clientes são armazenados com criptografia, em servidores seguros, e nunca são compartilhados com terceiros. Você pode exportar tudo a qualquer momento.",
  ],
  [
    "Consigo colocar meu time inteiro para trabalhar dentro dele?",
    "Sim. Você adiciona membros do time, distribui conversas, acompanha o pipeline de vendas e vê relatórios de tudo em um lugar só. O limite de membros e de números de WhatsApp depende do plano escolhido.",
  ],
  [
...
const getPlanAudience = (plan: PlatformPlan) => {
  ...
  if (slug.includes("pro")) return "Para empresas que querem crescer com IA em todo o funil.";
  if (slug.includes("max") || slug.includes("scale") || slug.includes("escritorio")) return "Para operações maiores, com time comercial e alto volume de atendimento.";
  return "Para quem está começando e quer automatizar o primeiro contato.";
};
...
export default function LandingPageGeneral() {
  ...
  const finalCta = isTrialFlow ? "Testar grátis" : "Ativar minha empresa agora";
  ...
  return (
    <div className="dark min-h-screen overflow-x-hidden bg-[#0b0b12] text-slate-100 antialiased">
      ...
      <main>
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.02fr_0.98fr]">
            <Reveal>
              <Badge className="mb-8 border border-pink-500/30 bg-pink-500/15 px-4 py-2 text-pink-100 hover:bg-pink-500/15">
                ...
                IA Plug'n'Play - para negócios reais
              </Badge>
              <h1 className="max-w-4xl text-5xl font-black leading-[1.03] tracking-tight text-white sm:text-6xl lg:text-7xl">
                A IA no seu negócio trabalhando <Em>24/7</Em>, e você foca no que importa.
              </h1>
              <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-300">
                Você não precisa se tornar um especialista em IA para automatizar a sua empresa. Nós fazemos isso por você. <br/><br/> Chega de aprender sobre prompts, Claude Code, GPT, Make ou qualquer coisa técnica para colocar a IA para trabalhar. O Wizzy entrega <strong className="font-semibold text-white">ferramentas de IA prontas</strong> - você ativa, elas trabalham.
              </p>
            ...
            <Reveal delay={120} className="relative">
              ...
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.035] shadow-2xl shadow-black/40 backdrop-blur">
                <div className="flex items-center gap-2 border-b border-white/10 bg-white/[0.04] px-5 py-4">
                  ...
                  <span className="ml-3 truncate text-xs font-medium text-slate-500">Wizzy CRM - Silva & Cia</span>
                </div>
          ...
          <div className="mx-auto grid max-w-7xl items-start gap-10 lg:grid-cols-[1fr_0.9fr]">
            <Reveal>
              <h2 className="text-4xl font-black leading-tight tracking-tight text-white sm:text-5xl">
                IA existe para todos. Mas nem todo empresário <Em>tem tempo</Em> para aprender. E está tudo bem!
              </h2>
              <p className="mt-6 text-lg leading-8 text-slate-400">
                ChatGPT, Claude, Make, n8n, Zapier, webhooks, prompts... Você abriu sua empresa para <strong className="text-white">vender e entregar</strong>, não para virar desenvolvedor de automações.
              </p>
              <p className="mt-5 text-lg leading-8 text-slate-400">
                Enquanto isso, leads chegam e somem, clientes ligam cobrando resposta, a agenda fica bagunçada - e o dinheiro fica na mesa.
              </p>
            ...
            <Reveal delay={120}>
              <div className="rounded-3xl border border-pink-500/25 bg-gradient-to-b from-pink-500/10 to-white/[0.03] p-7 shadow-2xl shadow-pink-500/10">
                ...
                <p className="mt-5 text-base leading-7 text-slate-400">
                  O Wizzy é um ecossistema de IA pensado de ponta a ponta para quem vende e atende. Sem código, sem configuração técnica, sem dependência de desenvolvedor.
                </p>
        ...
        <section id="segmentos" className="px-4 py-24 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <SectionHeader
              tag="Para qualquer negócio"
              title={<>Se você atende cliente no WhatsApp, <Em>o Wizzy serve para você</Em></>}
              subtitle="Os mesmos agentes, adaptados à linguagem e ao funil do seu segmento."
            />
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {segments.map(([name, desc], index) => (
                <Reveal key={name} delay={index * 45}>
                  <div className="flex h-full items-start gap-4 rounded-2xl border border-white/10 bg-white/[0.035] p-6 transition hover:-translate-y-1 hover:border-pink-500/30">
        ...
        <section id="produtos" className="bg-[#11111b] px-4 py-24 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <SectionHeader
              ...
              title={<>Tudo que sua empresa precisa, <Em>integrado e pronto</Em></>}
              subtitle="Cada ferramenta foi construída para quem vende. Não para engenheiros."
            />
        ...
        <section id="agentes" className="px-4 py-24 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <SectionHeader
              ...
              subtitle="Cada agente sabe exatamente o que fazer - e quando fazer - dentro do seu funil."
            />
            <Reveal>
        ...
        <section id="depoimentos" className="bg-[#11111b] px-4 py-24 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <SectionHeader tag="Depoimentos" title={<>Empresas que já <Em>pararam de perder tempo</Em></>} />
        ...
        <section id="planos" className="bg-[#f6f6f4] px-4 py-24 text-slate-900 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto mb-12 max-w-3xl text-center">
              ...
              <p className="mt-5 text-base leading-7 text-slate-600">Planos pensados para o tamanho da sua operação. Cancele quando quiser.</p>
        ...
        <section id="faq" className="px-4 py-24 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <SectionHeader tag="Dúvidas frequentes" title={<>Perguntas que <Em>todo empresário faz</Em></>} />
        ...
        <section className="relative overflow-hidden px-4 py-28 sm:px-6 lg:px-8">
          ...
          <div className="relative mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-white/90">
              Enquanto você lê isso, um concorrente está atendendo um lead que poderia ser seu. Ative o Wizzy agora.
            </p>
